  ...
  return (
    <div className="bg-cream min-h-screen text-charcoal font-sans">
      ...
      <section className="relative min-h-[90vh] flex flex-col justify-center items-center px-6 md:px-12 py-16 bg-[#FDF6F0] overflow-hidden">
        ...
        <svg className="absolute top-0 right-0 opacity-15 pointer-events-none" width="400" height="400" viewBox="0 0 200 200">
          <path fill="#C4687A" d="M44.7,-76.4C58.1,-69.2,69.2,-56.1,77.3,-41.2C85.4,-26.3,90.5,-9.6,88.7,6.3C86.9,22.2,78.2,37.3,66.8,49.1C55.4,61,41.4,69.6,26.4,74.8C11.3,79.9,-4.9,81.6,-20.5,78.3C-36.1,75.1,-51.2,66.9,-63.5,54.8C-75.7,42.7,-85.2,26.7,-88.1,9.8C-91,-7,-87.3,-24.8,-78,-39.2C-68.7,-53.6,-53.8,-64.7,-38.7,-71.2C-23.7,-77.7,-8.4,-79.6,7.6,-79.6C23.6,-79.6,44.7,-76.4,44.7,-76.4Z" transform="translate(100 100)" />
        </svg>
        ...
        >
          ...
          <p className="text-lg md:text-xl text-charcoal/80 max-w-xl mx-auto font-light leading-relaxed mb-10">
            "Enhance your natural beauty with perfect brows and flawless skin!" Offered in an intimate public-private home studio in Woodland, CA.
          </p>
          ...
          <div className="mt-8 flex items-center justify-center gap-2 text-charcoal/70 text-sm">
            ...
            <a href={`tel:${info.phone}`} className="font-bold underline text-dusty hover:text-dusty/80">
              {info.phone}
            </a>
          </div>
        </motion.div>
        ...
        <div className="mt-12 z-10 opacity-75 max-w-md w-full px-8 pointer-events-none">
          <svg viewBox="0 0 400 100" className="w-full text-dusty/30" stroke="currentColor" fill="none" strokeWidth="2.5" strokeLinecap="round">
            {/* Left Brow */}
            ...
            <path d="M 200,60 C 197,55 192,55 190,58 C 188,61 193,67 200,72 C 207,67 212,61 210,58 C 208,55 203,55 200,60 Z" fill="#C4687A" stroke="none" className="opacity-40" />
          </svg>
        </div>
      </section>
      ...
      <section id="services" className="py-24 px-6 md:px-12 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-sm text-charcoal/60 max-w-md mx-auto italic">
            Meticulously mapped to matching structure. Strictly sterile cotton strands.
          </p>
        </div>
        ...
        <div className="bg-white border-2 border-blush/20 rounded-3xl p-8 md:p-12 shadow-xl shadow-dusty/5 relative overflow-hidden">
          ...
          <div className="space-y-8">
            {activeServices.length === 0 ? (
              <p className="text-center text-charcoal/60 py-6">No services are loaded at the moment.</p>
            ) : (
                ...
                <div key={service.id} className="group">
                  <div className="dotted-leader-container">
                    <span className="font-serif text-xl md:text-2xl font-semibold text-charcoal flex items-center gap-2 group-hover:text-dusty/90 transition-colors">
                      {service.name === 'Eyebrow Threading' && <Heart size={16} className="text-dusty fill-dusty/20" />}
                      {service.name === 'Full Face' && <Sparkles size={16} className="text-gold" />}
                      {service.name === 'Henna' && <Star size={16} className="text-gold fill-gold/10" />}
                      {service.name}
                    </span>
          ...
          <div className="mt-14 pt-8 border-t border-blush/20 text-center">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-lg mx-auto">
              <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-cream border border-blush/10 hover:border-dusty/30 transition-all">
                <span className="text-xs font-semibold text-dusty tracking-widest uppercase">Zelle</span>
                <span className="text-[9px] text-charcoal/50 mt-1">Instant Transfer</span>
              </div>
              <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-cream border border-blush/10 hover:border-dusty/30 transition-all">
                <span className="text-xs font-semibold text-[#008CFF] tracking-widest uppercase">Venmo</span>
                <span className="text-[9px] text-charcoal/50 mt-1">@BrowBlissStudio</span>
              </div>
              <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-cream border border-blush/10 hover:border-dusty/30 transition-all">
                <span className="text-xs font-semibold text-charcoal tracking-widest uppercase"> Pay</span>
                <span className="text-[9px] text-charcoal/50 mt-1">Tap/Phone Link</span>
              </div>
              <div className="flex flex-col items-center justify-center p-3 rounded-2xl bg-cream border border-blush/10 hover:border-dusty/30 transition-all">
                <span className="text-xs font-semibold text-gold tracking-widest uppercase">Cash</span>
                <span className="text-[9px] text-charcoal/50 mt-1">Exact Change</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="md:w-1/2 space-y-6">
            ...
            <div className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-charcoal/90 font-medium">Hygienic, premium sanitary single-use organic cotton threads</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-blush/10 flex items-center justify-center">
                  <Check size={12} className="text-dusty" />
                </div>
                <span className="text-sm text-charcoal/90 font-medium">Calming skincare application using soft aloe vera post-threading</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-6 h-6 rounded-full bg-blush/10 flex items-center justify-center">
                  <Check size={12} className="text-dusty" />
                </div>
                <span className="text-sm text-charcoal/90 font-medium">Tailored and custom brow mapping mapped specifically for your jaw and gaze</span>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {galleryImages.map((image, index) => (
              <div key={index} className="group overflow-hidden rounded-2xl shadow-md bg-white border border-blush/10 hover:shadow-xl transition-all duration-300">
                <div className="relative overflow-hidden h-64">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-charcoal/70 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-305 flex items-end p-4">
                    <p className="text-xs font-medium text-white italic tracking-wide">{image.caption}</p>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((test, i) => (
              <div key={i} className="bg-white rounded-3xl p-8 border border-blush/20 shadow-md flex flex-col justify-between">
                <div>
                ...
                <div className="border-t border-cream pt-4">
                  ...
                  <p className="text-[10px] text-charcoal/40 uppercase tracking-widest">{test.city}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/2 bg-cream/50 rounded-3xl p-8 border border-blush/20 h-fit">
            ...
            <div className="space-y-4 font-sans text-sm">
              {businessHours.map((hr) => (
                <div key={hr.id} className="flex justify-between items-center pb-2 border-b border-blush/10">
                  <span className="font-semibold text-charcoal">{hr.day_name}</span>
                  {hr.is_closed ? (
                    <span className="text-xs px-2.5 py-0.5 rounded-full bg-charcoal/15 text-charcoal/60 uppercase tracking-wider font-semibold">Closed</span>
                  ) : (
                    <span className="text-charcoal/80 font-medium">
                      {hr.open_time} AM — {hr.close_time} PM
                    </span>
                  )}
                </div>
              ))}
          ...
          <div className="md:w-1/2 flex flex-col justify-center space-y-6">
            ...
            <p className="text-charcoal/80 leading-relaxed font-light">
              BrowBliss operates out of a delightful private home setting directly within Woodland, CA. This allows us to cut massive commercial salon overhead and provide high-end, luxurious detail styling back to our clients for only $6.
            </p>
            ...
            <div className="p-4 rounded-2xl bg-cream border border-gold/30 flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-dusty">Address Privacy Guaranteed</p>
                <p className="text-xs text-charcoal/70 mt-1">To ensure private safety, the exact street address card is instantly messaged to your phone and email right after setting your time slot.</p>
              </div>
            </div>
      ...
      <section className="py-20 bg-gradient-to-r from-dusty/10 via-blush/20 to-dusty/10 border-y border-blush/10 text-center px-6">
        <div className="max-w-xl mx-auto">
          ...
          <h2 className="text-4xl font-serif font-bold text-charcoal mb-4">Are you ready for lovely lines?</h2>
          <p className="text-sm text-charcoal/70 mb-8 font-light">Book your private session in seconds and look your sparkling best.</p>
          <button
            onClick={() => setRoute('/book')}
